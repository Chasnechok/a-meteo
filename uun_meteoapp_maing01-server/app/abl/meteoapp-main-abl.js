...
const Errors = require("../api/errors/meteoapp-main-error.js");
...
const logger = LoggerFactory.get("MeteoappMainAbl");

class MeteoappMainAbl {
  constructor() {
...
module.exports = new MeteoappMainAbl();
